...
export const FlowerIcon = (props) => {
    return (
        <svg width={props.width} height={props.height} viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M20.5 25.625C23.3305 25.625 25.625 23.3305 25.625 20.5C25.625 17.6695 23.3305 15.375 20.5 15.375C17.6695 15.375 15.375 17.6695 15.375 20.5C15.375 23.3305 17.6695 25.625 20.5 25.625Z" stroke={props.selected ? "#000" : "#D1D1D1"} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M13.6667 27.3333L16.2292 24.7708" stroke={props.selected ? "#000" : "#D1D1D1"} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M24.7708 16.2292L27.3333 13.6667" stroke={props.selected ? "#000" : "#D1D1D1"} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M13.6667 13.6667L16.2292 16.2292" stroke={props.selected ? "#000" : "#D1D1D1"} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M24.7708 24.7708L27.3333 27.3333" stroke={props.selected ? "#000" : "#D1D1D1"} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
...
export const BarChartIcon = (props) => {
    return (
        <svg width={props.width} height={props.height} viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M30.75 29.0417V15.375" stroke={props.selected ? "#000" : "#D1D1D1"} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M22.2083 29.0417V8.54175" stroke={props.selected ? "#000" : "#D1D1D1"} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M13.6667 29.0417V23.9167" stroke={props.selected ? "#000" : "#D1D1D1"} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
...
export const Add = (props) => {
    return (
        <svg fill="none" height={props.height} viewBox="0 0 32 32" width={props.width} xmlns="http://www.w3.org/2000/svg"><rect fill="#fff" height="31" rx="5.5" width="31" x=".5" y=".5" /><rect height="31" rx="5.5" stroke="#e2e8f0" width="31" x=".5" y=".5" /><g stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.33333"><path d="m16 11.3334v9.3333" /><path d="m11.3333 16h9.3333" /></g></svg>
    )
}
